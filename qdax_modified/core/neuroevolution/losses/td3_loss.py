...
from qdax_modified.core.neuroevolution.buffers.buffer import Transition
from qdax_modified.custom_types import Action, Descriptor, Observation, Params, RNGKey
