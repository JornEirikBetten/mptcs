...
import qdax_modified.environments
from qdax_modified import environments
from qdax_modified.core.neuroevolution.buffers.buffer import QDTransition, Transition
from qdax_modified.core.neuroevolution.mdp_utils import generate_unroll, generate_unroll_actor_dc
from qdax_modified.core.neuroevolution.networks.networks import MLP
...
def create_default_brax_task_components(
    ...
    bd_extraction_fn = qdax_modified.environments.behavior_descriptor_extractor[env_name]
