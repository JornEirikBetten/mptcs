from qdax_modified.tasks.qd_suite.archimedean_spiral import (
    ArchimedeanBD,
    ArchimedeanSpiralV0,
    ParameterizationGenotype,
)
from qdax_modified.tasks.qd_suite.deceptive_evolvability import DeceptiveEvolvabilityV0
from qdax_modified.tasks.qd_suite.ssf import SsfV0
